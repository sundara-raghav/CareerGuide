...
QUESTION_BANK: list[dict] = [
    # LOGICAL (10 questions)
    {
        "id": 1,
        "section": "logical",
        "text": "If all roses are flowers and some flowers fade quickly, which is definitely true?",
        "options": [
            {"key": "A", "text": "All roses fade quickly"},
            {"key": "B", "text": "Some roses may fade quickly"},
            {"key": "C", "text": "No roses fade quickly"},
            {"key": "D", "text": "All flowers are roses"},
        ],
        "correct_key": "B",
        "weight": 1,
    },
    ...
    },
    {
        "id": 3,
        "section": "logical",
        "text": "Which shape completes the pattern: Circle, Triangle, Square, Circle, Triangle, ?",
        "options": [
            {"key": "A", "text": "Circle"},
            {"key": "B", "text": "Triangle"},
            {"key": "C", "text": "Square"},
    ...
    },
    {
        "id": 12,
        "section": "verbal",
        "text": "Fill in the blank: She was _____ praised for her courage.",
        "options": [
            {"key": "A", "text": "harshly"},
            {"key": "B", "text": "rarely"},
            {"key": "C", "text": "widely"},
    ...
    # SOCIAL (8 questions)
    {
        "id": 31,
        "section": "social",
        "text": "You see a classmate struggling with an assignment. You would:",
        "options": [
            {"key": "A", "text": "Ignore — it's their problem"},
            {"key": "B", "text": "Offer to help and explain"},
            {"key": "C", "text": "Tell the teacher"},
            {"key": "D", "text": "Do it for them"},
        ],
        "correct_key": "B",
        "weight": 1,
    },
    {
        "id": 32,
        "section": "social",
        "text": "In a group project conflict, you would:",
        "options": [
            {"key": "A", "text": "Dominate and impose your view"},
            {"key": "B", "text": "Quit the group"},
            {"key": "C", "text": "Facilitate a discussion and find middle ground"},
            {"key": "D", "text": "Let others decide everything"},
        ],
        "correct_key": "C",
        "weight": 1,
    },
    # CREATIVE (8 questions)
    {
        "id": 41,
        "section": "creative",
        "text": "How many uses can you think of for a brick? This question tests:",
        "options": [
            {"key": "A", "text": "Memory"},
            {"key": "B", "text": "Divergent thinking"},
    ...
    },
    {
        "id": 42,
        "section": "creative",
        "text": "You love drawing posters and making short films. This suggests aptitude for:",
        "options": [
            {"key": "A", "text": "Accounting"},
            {"key": "B", "text": "Law"},
            {"key": "C", "text": "Visual arts and media"},
            {"key": "D", "text": "Chemistry"},
        ],
        "correct_key": "C",
        "weight": 1,
    },
    # TECHNICAL (10 questions)
    {
        "id": 51,
        "section": "technical",
        "text": "Which component stores data permanently in a computer?",
        "options": [
            {"key": "A", "text": "RAM"},
            {"key": "B", "text": "CPU"},
            {"key": "C", "text": "Hard Disk"},
            {"key": "D", "text": "GPU"},
        ],
        "correct_key": "C",
        "weight": 1,
    ...
    },
    {
        "id": 53,
        "section": "technical",
        "text": "Which programming concept allows code reuse?",
        "options": [
            {"key": "A", "text": "Variable"},
            {"key": "B", "text": "Loop"},
            {"key": "C", "text": "Function"},
